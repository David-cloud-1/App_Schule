  ...
  if (success) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-[#111827] px-4">
        <div className="bg-[#58CC02]/20 rounded-2xl p-4 mb-6">
          <Truck className="w-10 h-10 text-[#58CC02]" />
        </div>
        <h2 className="text-xl font-bold text-[#F9FAFB] mb-2 text-center">
          Fast geschafft! 🎉
        </h2>
      ...
      <div className="flex-1 flex flex-col items-center px-4 py-8">
        <div className="w-full max-w-sm">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="space-y-1">
              <Label htmlFor="confirmPassword" className="text-[#9CA3AF]">Passwort wiederholen</Label>
              <Input
                id="confirmPassword"
                type="password"
                placeholder="••••••••"
              ...
              {errors.confirmPassword && (
                <p className="text-xs text-[#FF4B4B]">{errors.confirmPassword.message}</p>
              )}
            </div>
          ...
          <div className="space-y-3">
            ...
            <Button
              ...
              disabled={oauthLoading !== null}
              className="w-full h-12 rounded-xl font-medium bg-[#1F2937] border border-[#4B5563] text-[#F9FAFB] hover:bg-[#374151]"
            >
              {oauthLoading === 'apple' ? (
                <Loader2 className="w-4 h-4 animate-spin" />
              ) : (
